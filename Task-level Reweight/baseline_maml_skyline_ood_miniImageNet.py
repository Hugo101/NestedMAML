...
parser.add_argument('--num_iterations', type=int, default=40000, metavar='N',
...
parser.add_argument('--ood_ratio', type=float, default=0.3)
...
def main(
    ...
    # Initialize weights for each cluster optimally, ID: 1, OOD: 0
    cluster_2_weight = torch.ones(CLUSTER_COUNT)
    cluster_2_weight[OOD_Labels] = 0

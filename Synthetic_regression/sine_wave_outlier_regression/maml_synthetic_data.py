...
class MAMLSinewave:
    ...
    def main(self):
        ...
        with open(r'maml_sine_losses' + str(self.shots) + str(self.task_ood_lv) + '.txt', 'w') as csv_file:
           csv_file.writelines(str_losses)

        torch.save(self.meta_model, 'maml_sine_model' + str(self.shots) + str(self.task_ood_lv) + '.pl')